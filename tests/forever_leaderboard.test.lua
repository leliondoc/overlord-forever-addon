...
OverlordDB = { config = {}, zones = {}, lastResetTimestamp = campaign,
    leaderboard = { kills = {}, captures = {}, playerInfo = {} }, leaderboardScoreSanitizeVersion = 4 }
...
OverlordDB = { config = {}, lastResetTimestamp = campaign, leaderboardScoreSanitizeVersion = 4 }
lb = loadLeaderboard()
